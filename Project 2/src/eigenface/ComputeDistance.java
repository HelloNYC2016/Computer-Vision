...
public class ComputeDistance {
	...
	public static void main(String args[]) throws Exception {
		//images/output/eigenfaces.seq images/output/mean-image.jpg images/output/weights.seq 195 231 images/train images/test images/output
		if (args.length != 8) {
		...
		for(String testImageFileName: testImageFileNames) {
			...
			Helper.writeImage(outputDirectory + "/test-diff-"+shortTestFileName, diffImagePixels, width, height);
