...
public class ComputeEigenFaces {	
	private static void writeEigenFaceImage(String filename, double[][] eigenFacePixels,
		...
		ImageIO.write(meanImage, "jpg", new File(filename));
	}
	...
	public static void main(String args[]) throws Exception {
		//images/output/covariance.seq images/output/diffmatrix.seq images/output/mean-image.jpg 195 231 images/train images/output
		if (args.length != 7) {
		...
		int rank = eigenVectors.length;
		for(int i = 0 ; i < rank ; i++) {
			writeEigenFaceImage(outputDirectory + "/eigenface-" + i + ".jpg", eigenFaces, width, height, i);
		}
